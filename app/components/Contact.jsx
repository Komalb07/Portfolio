...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "616c7d04-dc16-474a-abe0-e1553519ac94");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none' >
      ...
      className='text-center text-5xl font-Ovo'>
        Here’s how we can connect</motion.h2>
        ...
        I am just a message away—feel free to reach out anytime!</motion.p>
